...
def user_select_os_mac():
    ...
    print("Operating System Select (Mac):\n", df)


def user_select_os_dos():
    df.update(os_dos_df, overwrite=True)
    print("Operating System Select (DOS):\n", df)
...
class ResultsWindowGUI:
    def showresultswindow(self):
        ...
        canvas = tk.Canvas(results, bg="#FFFFFF", height=600,
                           width=1000, bd=0, highlightthickness=0, relief="ridge")
        canvas.place(x=0, y=0)
        canvas.create_rectangle(0.0, 0.0, 418.0, 600.0,
                                fill="#007BFF", outline="")
        canvas.create_rectangle(0.0, 60.0, 418.0, 507.0,
                                fill="#6C757D", outline="")
        canvas.create_rectangle(0.0, 57.0, 418.0, 63.0,
                                fill="#FFFFFF", outline="")
        ...
        image_2 = canvas.create_image(706.0, 414.0, image=image_image_2)
        ...
        canvas.create_text(25.0, 89.0, anchor="nw", text="The best way to find the right laptop that works for you!",
                           fill="#FFFFFF", font=("RobotoRoman Regular", 15 * -1))
        canvas.create_text(502.0, 307.0, anchor="nw", text="To download your results as a PDF file, Click DOWNLOAD Below!",
                           fill="#000000", font=("RobotoRoman Regular", 15 * -1))
        canvas.create_text(113.0, 551.0, anchor="nw", text="Exit at any time to close the window",
                           fill="#FFFFFF", font=("RobotoRoman Regular", 12 * -1))
        canvas.create_text(649.0, 12.0, anchor="nw", text="Your Results",
                           fill="#000000", font=("RobotoRoman Regular", 24 * -1))

        canvas.create_rectangle(0.0, 57.0, 1000.0, 63.0,
                                fill="#D9D9D9", outline="")
        canvas.create_rectangle(418.0, 504.0, 1000.0,
                                510.0, fill="#D9D9D9", outline="")
        ...
        button_1.place(x=656.0, y=522.0, width=120.0, height=36.44775390625)
        ...
        button_2.place(x=680.0, y=569.0, width=72.0, height=18.44775390625)

        entry_image_1 = PhotoImage(file=relative_to_assets("entry_1_a.png"))
        entry_bg_1 = canvas.create_image(715.5, 187.5, image=entry_image_1)
        label = tk.Label(results, text=datalabel, font=(
            "RobotoRoman Regular", 10 * -1))
        label.place(x=457.0, y=89.0, width=517.0, height=195.0)
...
window.title("Laptop Price Calculator - Dev Version")
...
canvas.create_text(148.0, 451.0, anchor="nw", text=" Easy, Simple!",
                   fill="#FFFFFF", font=("RobotoRoman Regular", 20 * -1))
canvas.create_text(500.0, 12.0, anchor="nw", text="DEV",
                   fill="#FF0000", font=("RobotoRoman Regular", 30 * -1))
canvas.create_text(84.0, 12.0, anchor="nw", text="Laptop Price Calculator",
                   fill="#FFFFFF", font=("RobotoRoman Regular", 24 * -1))
